...
public class PacketDataOutputStream extends FilterOutputStream implements DataOutput {
    /**
    ...
    static int writeUTF(String str, DataOutput out) throws IOException {
        ...
        if (out instanceof DataOutputStream) {
            PacketDataOutputStream dos = (PacketDataOutputStream)out;
     ...
     * @see     PacketDataOutputStream#written
     */
