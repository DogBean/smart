...
public class PacketDataInputStream extends FilterInputStream implements DataInput {
    ...
    public final static String readUTF(DataInput in) throws IOException {
        ...
        if (in instanceof DataInputStream) {
            PacketDataInputStream dis = (PacketDataInputStream)in;
