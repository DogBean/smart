...
public class TimerText extends RoundTextView implements View.OnClickListener {
    /**
     * 倒计时时长，默认倒计时时间60秒；
     */
    ...
    public void setOnClickListener(OnClickListener onclickListener) {
        if (onclickListener instanceof TimerText) {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            TimerText.this.setText(length / 1000 + afterText);
            length -= 1000;
            if (length < 0) {
                TimerText.this.setEnabled(true);
                TimerText.this.setText(beforeText);
                clearTimer();
                length = 60 * 1000;
            }
        }
