package com.lingzhi.smart.module.music.source;
...
import com.lingzhi.smart.module.music.DBUtils;
import com.lingzhi.smart.module.music.model.Folder;
import com.lingzhi.smart.module.music.model.PlayList;
import com.lingzhi.smart.module.music.model.Song;
import com.lingzhi.smart.module.music.PreferenceManager;
...
/* package */ class AppLocalDataSource implements AppContract {
    ...
    @Override
    public io.reactivex.Observable<List<PlayList>> playLists() {
        return io.reactivex.Observable.create(new ObservableOnSubscribe<List<PlayList>>() {
            @Override
    ...
    public Observable<PlayList> create(final PlayList playList) {
        return Observable.create(new ObservableOnSubscribe<PlayList>() {
            @Override
            public void subscribe(ObservableEmitter<PlayList> e) throws Exception {
                Date now = new Date();
    ...
    public Observable<Folder> create(final Folder folder) {
        return Observable.create(new ObservableOnSubscribe<Folder>() {
            @Override
            public void subscribe(ObservableEmitter<Folder> e) throws Exception {
    ...
    public Observable<Song> update(final Song song) {
        return Observable.create(new ObservableOnSubscribe<Song>() {
            @Override
            public void subscribe(ObservableEmitter<Song> e) throws Exception {
